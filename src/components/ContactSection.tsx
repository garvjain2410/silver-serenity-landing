      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            <SectionTitle
              title="Get In Touch"
              subtitle="Ready to elevate your jewelry collection? Contact us for wholesale inquiries and partnership opportunities."
            />
            
            <div className="slide-in space-y-6">
              <div className="flex items-start gap-4">
                <div className="bg-silver-light p-3 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-silver-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">wholesale@silverelite.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">123 Silver Lane, Suite 500<br />New York, NY 10001</p>
                </div>
              </div>
              
              <div className="flex items-center gap-4 mt-8">
                <a href="#" className="bg-silver-light p-3 rounded-full hover:bg-silver transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-silver-dark" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="slide-in" style={{ transitionDelay: "300ms" }}>
            <Card>
              <CardContent className="p-6">
                <h3 className="font-playfair text-2xl font-medium mb-6">Wholesale Inquiry</h3>
                <form onSubmit={handleSubmit}>
                  <div className="space-y-4">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-silver-dark hover:bg-silver-dark/90 text-white"
